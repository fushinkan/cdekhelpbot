...
class CustomerKeyboards():
    ...
    async def edit_or_confirm(cls):
        return InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="✏️ Договор", callback_data="edit_contract_number"), InlineKeyboardButton(text="✏️ Город отправления", callback_data="edit_departure_city")],
            ...
            [InlineKeyboardButton(text="✏️ Сумма страховки", callback_data="edit_insurance_amount")],
